...
int main() {
    ...
    Console::puts("kernel_mem_pool"); Console::puts("\n");
    ...
    Console::puts("passed info needed "); Console::puts("\n");
    unsigned long process_mem_pool_info_frame = kernel_mem_pool.get_frames(n_info_frames);
    Console::puts("process_mem_pool_info_frame  "); Console::puts("\n");
    
    ContFramePool process_mem_pool(PROCESS_POOL_START_FRAME,
                                   PROCESS_POOL_SIZE,
                                   process_mem_pool_info_frame);
    
    Console::puts("process_mem_pool "); Console::puts("\n");
    process_mem_pool.mark_inaccessible(MEM_HOLE_START_FRAME, MEM_HOLE_SIZE);
    Console::puts("mark_inaccessible "); Console::puts("\n");
